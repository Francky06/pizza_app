...
class ExtensibleText extends StatefulWidget {

  final String text;


  const ExtensibleText({Key? key,
  required this.text}) : super(key: key);

  @override
  State<ExtensibleText> createState() => _ExtensibleTextState();
}

class _ExtensibleTextState extends State<ExtensibleText> {
